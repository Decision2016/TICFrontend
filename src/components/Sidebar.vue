  ...
  <div class="comp-sidebar">
    <nav class="sidebar-nav nav">
      <ul class="side-menu">
        <li>
          <!--todo:代码重复，待优化-->
          <router-link :class="active==='dashboard'?'menu-item active':'menu-item'" @click="active=0" to="/admin">
            <!--svg icon-->
        ...
        <li>
          <router-link :class="active==='carousel'?'menu-item active':'menu-item'" to="/admin/carousel">
            <!--svg icon-->
            ...
            <span class="menu-name">轮播图管理</span>
          </router-link>
        </li>
        <li>
          <router-link :class="active==='personnel'?'menu-item active':'menu-item'" to="/admin/personnel">
            <!--svg icon-->
            ...
            <span class="menu-name">现任成员展示</span>
          </router-link>
        </li>
        <li>
          <router-link :class="active==='articles'?'menu-item active':'menu-item'" to="/admin/articles">
            <!--svg icon-->
        ...
        <li>
          <router-link :class="active==='setting'?'menu-item active':'menu-item'" to="/admin/setting">
            <!--svg icon-->
        ...
        <li>
          <router-link :class="active==='log'?'menu-item active':'menu-item'" to="/admin/log">
            <!--svg icon-->
            ...
            <span class="menu-name">日志查询</span>
          </router-link>
        </li>
        <li>
